...
const [nationality, setNationality] = useState("Japan");
  ...
  className="bg-green-500 text-white py-2 px-4 rounded-md hover:bg-green-600 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed"
  disabled={true} // Thêm thuộc tính disabled để vô hiệu hóa
>
  Ứng tuyển
</button>
...
<aside className="space-y-6">
  ...
  <div className="bg-white p-6 rounded-md shadow-md border">
    <h2 className="text-lg font-bold mb-4 text-center">Trạng thái tin</h2>

  <div className="bg-gray-200 p-6 rounded-md shadow-md border">
  <p className=" text-black text-sm text-center ">Bị từ chối</p>
  </div>
  </div>
...
<div className="bg-white p-6 rounded-md shadow-md border">
    {/* Company Info */}
    <div className="bg-white p-6 rounded-md shadow-md border">
    <h2 className="text-lg font-bold mb-4 text-center">Lý do</h2>

  <div className="bg-gray-200 p-6 rounded-md shadow-md border">
  <p className=" text-black text-sm text-center ">Hết thời hạn thanh toán</p>
  </div>
  </div>
</div>
